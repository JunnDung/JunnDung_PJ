    ...
    <main>
      ...
      <article className="mx-auto max-w-7xl px-5 py-10 sm:px-8 lg:px-10">
        <header className="mx-auto max-w-3xl py-10 text-center reveal-up">
          ...
          <h1 className="font-serif text-4xl font-black leading-tight tracking-tight text-slate-950 md:text-6xl">
            {article.title}
          </h1>
        ...
        <div className="grid gap-10 lg:grid-cols-[220px_minmax(0,var(--reading-width))_260px] lg:justify-center">
          ...
          <div className="min-w-0">
            <div className="mb-8 grid gap-4 lg:hidden">
              <PostActions title={article.title} url={articleUrl} slug={article.slug} />
              <ReadingPreferences />
            </div>
            ...
            <div className="prose-editorial text-slate-700">
              {article.sections.map((section, index) => (
                <section key={section.id} id={section.id} className="scroll-mt-28">
                  ...
                  {index === 1 && (
                    <blockquote>
                      “A tool is never neutral when it decides which forms of
                      attention feel natural.”
                    </blockquote>
                  )}
                  ...
                  {index === 3 && (
                    <>
                      <div className="note">
                        <strong className="text-slate-800">Research note:</strong>{" "}
                        preserve friction where judgment needs time. Remove
                        friction where repetition wastes attention.
                      </div>
                      <pre>
                        <code>{`const usefulFriction = {
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 leading-7 text-slate-600">
                      Writes reflective essays on technology, culture, books,
                      design, and philosophy. Interested in slow systems,
                      serious reading, and humane digital environments.
                    </p>
                  </div>
                </div>
              </div>
